...
if (isset($_POST['submit'])) {
    ...
    //往users表里面插入默认的数据
    $insert_users = "insert into `users` (`id`,`username`,`password`,`level`) values (1,'admin',md5('12345678'),1),(2,'jack',md5('000000'),2),(3,'test',md5('abc123'),3)";
    ...
    (1, 'vince', md5('123456'), 'boy', '18626545453', 'chain', 'vince@jack.com'),
    (2, 'allen', md5('123456'), 'boy', '13676767767', 'nba 76', 'allen@jack.com'),
    (3, 'kobe', md5('123456'), 'boy', '15988767673', 'nba lakes', 'kobe@jack.com'),
    (4, 'grady', md5('123456'), 'boy', '13676765545', 'nba hs', 'grady@jack.com'),
    (5, 'kevin', md5('123456'), 'boy', '13677676754', 'Oklahoma City Thunder', 'kevin@jack.com'),
    (6, 'lucy', md5('123456'), 'girl', '12345678922', 'usa', 'lucy@jack.com'),
    (7, 'lili', md5('123456'), 'girl', '18656565545', 'usa', 'lili@jack.com')";
    ...
    $mes_ok = "<p class='notice'>OK～<a href='login.php'>点击这里</a></p>";
